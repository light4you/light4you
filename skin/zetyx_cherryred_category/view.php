...
<table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor=<?=$sC_light1?>>
<tr>
...
<? if($data[email]) 
{ 
?> <font style=font-size:7pt;font-family:Tahoma;font-weight:normal>[<a href=mailto:"<?=$data[email]?>"><?=$data[email]?></a>]</font>
<?  } ?>
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
<tr>
 <td style='word-break:break-all;padding:10px;' bgcolor=#ffffff height=100 valign=center>
