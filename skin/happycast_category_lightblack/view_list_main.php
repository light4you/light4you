...
<tr align=center bgcolor=<?=$list_bg_color?> onMouseOver=this.style.backgroundColor='<?=$list_mouse_over_color?>' onMouseOut=this.style.backgroundColor=''>
  <td height=22 class=listnum><?=$number?></td>
  <td align=left style='word-break:break-all;'><img src=images/t.gif height=3><br><?=$insert?><?=$icon?><?=$subject?> <font class=comment_num><?=$comment_num?></font></td>
