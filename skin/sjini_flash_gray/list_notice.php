...
///////////////////////////////////////////////////////////////////////// ?>
<!-- 목록 부분 시작 -->
<td colspan=<?=$max_show_image?>> 
    <table border=0 width=100% cellspacing=4 cellpadding=0 class=sjini-nbox>
    <tr>
    <td valign=top align=center style='word-break:break-all;'>
     ...
     <?=$a_modify?><img src=<?=$dir?>/img/modify.gif border=0></a>&nbsp;
     <?=$a_delete?><img src=<?=$dir?>/img/delete.gif border=0></a>&nbsp;
     <?=$data[memo]?>
    </td>
    </tr>
    </table>
...
<tr><td class=sjini-blank height=10></td></tr>
<tr align=center>
