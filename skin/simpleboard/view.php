...
<tr align=center>
    <td>
      <table width=30 height=2 border=0 cellspacing=0 cellpadding=0 background=<?=$dir?>/line_left.gif>
        <tr>
          <td>
...
<tr bgcolor=white>
 <td width=100 height=23 >&nbsp;<img src=<?=$dir?>/file.gif border=0></td>
...
<tr bgcolor=white>
 <td width=100  height=23 >&nbsp;<img src=<?=$dir?>/file2.gif border=0></td>
...
<tr bgcolor=white>
 <td width=100  height=23 >&nbsp;<img src=<?=$dir?>/link2.gif border=0></td>
 <td >&nbsp;&nbsp;<?=$sitelink2?></td>
</tr>
