...
<? include "$dir/value.php3"; ?>
  ...
  <tr align=center>
    <td class=tver height=19>
      <?=$number?>
    </td>
    <?=$hide_cart_start?><td></td><?=$hide_cart_end?>


    <td align=left style='word-break:break-all;' height=19>
     <?=$insert?><?=$icon?><?=$subject?>
      <span style="font-size:7pt;"><font face="tahoma" color="ADAEAF"><?=$comment_num?></font></span>
    </td>

    <td style='word-break:break-all;' height=19>
      <?=$face_image?> <?=$name?>
    </td>
    <td class=tahoma height=19 align=center><?=$reg_date?></td>
    <td class=tahoma height=19 align=center><?=$hit?></td>
  </tr>
  <tr>
