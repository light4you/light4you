...
<tr align=center>
  <td height=19 align=center>
    <img src=<?=$dir?>/list_notice.gif border=0></td>
<?=$hide_cart_start?><td></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'><?=$insert?><?=$icon?><?=$subject?>
      <span style="font-size:7pt;"><font face="Verdana" color="9D9D9D"><?=$comment_num?></font></span>
  </td>
  <td style='word-break:break-all;'><?=$name?></div></td>
