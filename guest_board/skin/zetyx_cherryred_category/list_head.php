...
<?=$hide_cart_end?>
  ...
  <td>
    <table border=0 height=18 cellspacing=0 cellpadding=0 width=80 background=<?=$dir?>/images/lh_bg.gif>
       <tr><td align=center valign=top><?=$a_name?><img src=<?=$dir?>/images/lh_name.gif border=0 alt="Sort by Name"></a></td></tr>
    </table>
  </td>
  <td>
    <table border=0 height=18 cellspacing=0 cellpadding=0 width=60 background=<?=$dir?>/images/lh_bg.gif>
       <tr><td align=center valign=top><?=$a_date?><img src=<?=$dir?>/images/lh_date.gif border=0 alt="Sort by Date"></a></td></tr>
    </table>
  </td>
  <td>
    <table border=0 height=18 cellspacing=0 cellpadding=0 width=25 background=<?=$dir?>/images/lh_bg.gif>
       <tr><td align=center valign=top><?=$a_hit?><img src=<?=$dir?>/images/lh_read.gif border=0 alt="Sort by Readed Count"></a></td></tr>
    </table>
  </td>
  <td>
    <table border=0 height=18 cellspacing=0 cellpadding=0 width=20 background=<?=$dir?>/images/lh_bg.gif>
