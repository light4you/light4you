...
<tr align=center bgcolor=<?=$sC_light01?>>
  <td class=thm8 nowrap align=center><img src=<?=$dir?>/notice.gif></td>
<?=$hide_cart_start?><td><input type=checkbox name=cart value="<?=$data[no]?>"></td><?=$hide_cart_end?>
  <td align=left style='word-break:break-all;'><img src=images/t.gif height=3><br>&nbsp; <?=$insert?><img src=<?=$dir?>/notice_head.gif align=absmiddle> <?=$subject?> <font style=font-family:Tahoma;font-size:6pt;font-weight:bold;letter-spacing:-1px;><?=$comment_num?></font></td> 
  <td style='word-break:break-all;'><img src=images/t.gif height=3><br><?=$face_image?> <?=$name?></div></td>
  <td class=thm8 nowrap><?=$reg_date?></td>
  <td class=thm8 nowrap><?=$hit?></td>
  <td class=thm8 nowrap><?=$vote?></td>
</tr>
<tr>
