...
<tr align=center onMouseOver=this.style.backgroundColor='<?=$list_mouse_over_color?>' onMouseOut=this.style.backgroundColor=''>
  <td width=30 height=22 nowrap style='font-family:Tahoma;font-size:8pt; padding:0 3'><?=$number?></td>
  <?=$hide_cart_start?>
  <td nowrap><input type=checkbox name=cart value="<?=$data[no]?>"></td><?=$hide_cart_end?>
  <?=$hide_category_start?>
  <td width=60 nowrap><img src=images/t.gif border=0 width=1 height=3><br><?=$category_name?></td><?=$hide_category_end?>
  <td align=left width=100% style='word-break:break-all; padding-left:5'><img src=images/t.gif border=0 width=1 height=3><br><?=$insert?><?=$icon?><?=$subject?> <font style='font-family:Tahoma;font-size:6pt'><?=$comment_num?></font></td> 
  <td align=left width=80 nowrap style='word-break:break-all;'><img src=images/t.gif border=0 width=1 height=3><br><?=$face_image?> <?=$name?></div></td>
  <td width=80 nowrap style='font-family:Tahoma;font-size:8pt'><?=$reg_date?></td>
  <td width=30 nowrap style='font-family:Tahoma;font-size:8pt'><?=$hit?></td>
</tr>
