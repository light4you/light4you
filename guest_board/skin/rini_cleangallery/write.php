...
<tr height=22>
  ...
  <td><input type=text name=subject value="<?=$subject?>" <?=size(60)?> maxlength=10 class=rini_input style="width:320;height:18;background-color:#FFFFFF">
  </td>
</tr>

<tr>
  <td width=70 align=right><font class=rini_ver>contents</font>&nbsp;&nbsp;&nbsp;</td>
  <td valign=top><textarea name=memo class=rini_textarea style='width:320px; height:200px'><?=$memo?></textarea>
  </td>
</tr>

<?=$hide_sitelink1_start?>
<tr height=22>
  <td width=70 align=right><font class=rini_ver>link</font>&nbsp;&nbsp;&nbsp;</td>
  <td><input type=text name=sitelink1 value="<?=$sitelink1?>" <?=size(60)?> maxlength=200 class=rini_input style="width:320;height:18;background-color:#FFFFFF">
  </td>
</tr>
<?=$hide_sitelink1_end?>
...
<tr height=22>
  <td width=70 align=right><font class=rini_ver>link 2</font>&nbsp;&nbsp;&nbsp;</td>
  <td><input type=text name=sitelink2 value="<?=$sitelink2?>" <?=size(60)?> maxlength=200 class=rini_input style="width:320;height:18;">
  </td>
</tr>
<?=$hide_sitelink2_end?>
...
<tr height=22>
  <td width=70 align=right><font class=rini_ver>image</font>&nbsp;&nbsp;&nbsp;</td>
  <td><input type=file name=file1 <?=size(50)?> maxlength=255 class=rini_input style="width:320;height:18;background-color:#FFFFFF"> <?=$file_name1?>
  </td>
</tr>
<?=$hide_pds_end?>
