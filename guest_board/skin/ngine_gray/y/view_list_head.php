...
<table border=0 cellspacing=0 cellpadding=0 width=100% background=<?=$dir?>/title_bg.gif>
<tr align=center>
   <td>
   <table width=100% height=23 border=0 cellspacing=0 cellpadding=0>
  <tr>
    <td><img src=<?=$dir?>/last_left.gif border=0></td><td align=center width=30 nowrap><img src=<?=$dir?>/title_no.gif border=0></td>
  </tr>
</table>
   </td>
...
<?=$hide_cart_start?>
  ...
  <tr>
    <td align=center nowrap><img src=<?=$dir?>/title_bs.gif border=0></td>
  </tr>
</table>
   </td>
<?=$hide_cart_end?>
...
<?=$hide_category_end?>
   ...
   <td width=100%>
       <table width=100% border=0 cellspacing=0 cellpadding=0>
  <tr>
    <td align=left><img src=<?=$dir?>/title_title.gif border=0></td>
  </tr>
</table>
  </td>
   <td>
  ...
  <tr>
    <td>&nbsp;</td><td align=right><img src=<?=$dir?>/last_right.gif border=0></td>
  </tr>
</table>
  </td>
</tr>
