...
<tr><td height=1 colspan=2 bgcolor=#ffffff><img src=images/t.gif height=1></td></tr>
<tr>
   <td colspan=2><table width=100% height=23 border=0 cellspacing=0 cellpadding=0 background=<?=$dir?>/title_bg.gif border=0>
  <tr>
   <td width=3><img src=<?=$dir?>/last_left.gif border=0></td><td align=left nowrap>&nbsp;&nbsp;<img src=<?=$dir?>/view_article.gif border=0></td><td align=right><img src=<?=$dir?>/last_right.gif border=0></td>
  </tr>
</table></td>
</tr>
</table>
...
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style=color:<?=$sC_dark0?>><b>Name&nbsp;&nbsp;</b></td>
...
<tr><td height=1 colspan=2 background=<?=$dir?>/dot_line.gif><img src=images/t.gif height=1></td></tr>
<?=$hide_homepage_start?>
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style=color:<?=$sC_dark0?>><b>Homepage&nbsp;&nbsp;</b></td>
...
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style=color:<?=$sC_dark0?>><b>File #1&nbsp;&nbsp;</b></td>
...
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style=color:<?=$sC_dark0?>><b>File #2&nbsp;&nbsp;</b></td>
...
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style=color:<?=$sC_dark0?>><b>Link #1&nbsp;&nbsp;</b></td>
...
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style=color:<?=$sC_dark0?>><b>Link #2&nbsp;&nbsp;</b></td>
...
<tr height=23>
 <td align=right class=thm8 width=100 bgcolor=<?=$sC_dark2?> style='word-break:break-all;color:<?=$sC_dark0?>'><b>Subject&nbsp;&nbsp;</b></td>
 <td><img src=images/t.gif height=3><br>&nbsp;&nbsp;<b><?=$subject?></b></td>
</tr>

<tr><td colspan=2 background=<?=$dir?>/dot_line.gif><img src=images/t.gif height=1></td></tr>
</table>
<table border=0 cellspacing=0 cellpadding=0 width=<?=$width?>>
<tr>
