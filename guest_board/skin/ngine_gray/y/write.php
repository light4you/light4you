...
<table border=0 cellspacing=0 cellpadding=0 width=550 height=23 background=<?=$dir?>/title_bg.gif>
<tr>
   <td colspan=2><table width=100% border=0 cellspacing=0 cellpadding=0>
  <tr><td width=3><img src=<?=$dir?>/last_left.gif border=0></td>
    <td>&nbsp;&nbsp;<?=$title?></td><td width=3 align=right><img src=<?=$dir?>/last_right.gif border=0></td>
  </tr>
</table></td>
</tr>
</table>
...
<tr>
  ...
  <td valign=top>
  <textarea name=memo <?=size2(70)?> rows=20 class=input ><?=$memo?></textarea>
  </td>
</tr>
...
<tr align=center height=30>
  <td align=center>
      ...
      <input type=button border=0 align=absmiddle onclick=history.go(-1) value=' back ' class=input></td>
</tr>
</table>
