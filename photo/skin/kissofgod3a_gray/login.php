...
<tr>
  <td align=right><b>아이디</b>　<input type=text name=user_id size=<?if($browser)echo"15";else echo"10";?> maxlength=20 class=kissofgod-input></td>
</tr>
<tr height=20><td><img src=images/t.gif width=1 height=1></td></tr>
<tr>
  <td align=right><b>비밀번호</b>　<input type=password name=password size=<?if($browser)echo"15";else echo"10";?> maxlength=20 class=kissofgod-input> </td>
</tr>
<tr height=20><td><img src=images/t.gif width=1 height=1></td></tr>
