...
<table border=0 cellspacing=1 cellpadding=0 width=550 style='padding:0 0 0 5'>
<tr>
...
<tr>
  ...
  <td> <input type=text name=name value="<?=$name?>" <?=size(20)?> maxlength=15 class=kissofgod-input>　　<b>비밀번호&nbsp;</b><input type=password name=password <?=size(20)?> maxlength=20 class=kissofgod-input> </td>
</tr>
<tr><td height=3 colspan=2><img src=images/t.gif width=1 height=1></td></tr>
<tr>
  <td><b>이메일&nbsp;</b></td>
  <td> <input type=text name=email value="<?=$email?>" <?=size(55)?> maxlength=200 class=kissofgod-input> </td>
</tr>
<tr><td height=3 colspan=2><img src=images/t.gif width=1 height=1></td></tr>
<tr>
  <td><b>홈페이지&nbsp;</b></td>
  <td> <input type=text name=homepage value="<?=$homepage?>" <?=size(55)?> maxlength=200 class=kissofgod-input> </td>
</tr>
<tr><td height=3 colspan=2><img src=images/t.gif width=1 height=1></td></tr>
<?=$hide_end?>

<tr>
  <td><img src=images/t.gif border=0 width=80 height=1><br><b>기타&nbsp;</b></td>
  <td> 
...
<tr>
  <td><b>제목&nbsp;</b></td>
  <td> <input type=text name=subject value="<?=$subject?>" <?=size(76)?> maxlength=200 class=kissofgod-input> </td>
</tr>
<tr><td height=3 colspan=2><img src=images/t.gif width=1 height=1></td></tr>
<tr>
  <td><b>내용&nbsp;</b></td>
  <td valign=top>
  <textarea name=memo <?=size2(74)?> rows=12 class=kissofgod-textarea><?=$memo?></textarea>
  </td>
</tr>
...
<tr>
  <td><b>링크 1&nbsp;</b></td>
  <td> <input type=text name=sitelink1 value="<?=$sitelink1?>" <?=size(76)?> maxlength=200 class=kissofgod-input></td>
</tr>
<tr><td height=3 colspan=2><img src=images/t.gif width=1 height=1></td></tr>
<?=$hide_sitelink1_end?>
...
<tr>
  <td><b>링크 2&nbsp;</b></td>
  <td> <input type=text name=sitelink2 value="<?=$sitelink2?>" <?=size(76)?> maxlength=200 class=kissofgod-input> </td>
</tr>
...
<tr>
  <td><b>화일 1&nbsp;</b></td>
  <td> <input type=file name=file1 <?=size(61)?> maxlength=255 class=kissofgod-input> <?=$file_name1?></td>
</tr>
<tr><td height=3 colspan=2><img src=images/t.gif width=1 height=1></td></tr>
<tr>
  <td><b>화일 2&nbsp;</b></td>
  <td> <input type=file name=file2 <?=size(61)?> maxlength=255 class=kissofgod-input> <?=$file_name2?></td>
</tr>
...
<tr>
  ...
  <td align=right><input type=image border=0 src="<?=$dir?>/btn_confirm.gif" accesskey="s" onfocus=blur()>　　
      <a href=# onclick=history.back() onfocus=blur()><img src=<?=$dir?>/btn_back.gif border=0></a></td>
</tr>
