...
<tr align=center bgcolor=<?=$sC_light0?>>
  <td class=thm8 height=20><?=$number?></td>
...
<?=$hide_category_start?><td><img src=images/t.gif height=3><br><?=$category_name?></td><?=$hide_category_end?>
  <td align=left style='word-break:break-all;'><img src=images/t.gif height=3><br><?=$insert?><?=$icon?><?=$subject?> <font style=font-family:Tahoma;font-size:7pt;><?=$comment_num?></font></td> 
