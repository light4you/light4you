...
<tr height=25 bgcolor=<?=$view_left_header_color?>>
  <td height=50 align=center><input type=text name=user_id size=<?if($browser)echo"15";else echo"10";?> maxlength=20 class=input style=height:18px;font-family:Arial;font-size:8pt;font-weight:bold;color:gray style="border-width:1px; border-color:rgb(153,153,153); border-style:solid;"></td>
  <td align=center><input type=password name=password size=<?if($browser)echo"15";else echo"10";?> maxlength=20 class=input style=height:18px;font-family:Arial;font-size:8pt;font-weight:bold;color:<?=$sC_dark1?> style="border-width:1px; border-color:rgb(153,153,153); border-style:solid;"> </td>
</tr>
<tr height=1><td colspan=2 bgcolor=<?=$view_divider?>><img src=images/t.gif height=1></td></tr>
</table>
<br>
