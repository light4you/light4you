...
<tr valign=top >
    <td width=70 nowrap style='padding:3 0 3 15'><?=$c_face_image?> <?=$comment_name?></td>
    <td style='word-break:break-all;padding:3 0 3 5'><p align=justify><?=nl2br($c_memo)?></p></td>
    <td align=right width=28 style='padding:0 0 3 0'><?=$a_del?><img src=<?=$dir?>/delete_2.gif border=0 alt='지웁시다'></td>
